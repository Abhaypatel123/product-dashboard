  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <p className="text-lg font-semibold text-muted">Loading product…</p>
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-14 md:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            {/* Title */}
            <h1 className="mt-4 text-3xl font-extrabold text-secondary">{product.title}</h1>
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 text-sm text-muted">
              <div>
                <p className="font-semibold text-secondary">🚚 Free Delivery</p>
